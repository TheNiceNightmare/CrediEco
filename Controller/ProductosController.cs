...
namespace CrediEco.Controller
{
    ...
    {
        private readonly CrediEcoDBContext _context;

        public ProductosController(CrediEcoDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Productos>> PostProductos(Productos productos)
        {
          if (_context.Productos == null)
          {
              return Problem("Entity set 'CrediEcoDBContext.Productos'  is null.");
          }
